        ...
        <div id="home">
           <div className="bg-dark text-white d-flex align-items-center" style={{height: 40, width: "100%"}}>
            <div className="container">
              ...
              <div className="float-start position-relative" data-aos="flip-left" data-aos-duration={3000} data-aos-delay={500}><span>Horizon Christian School Certificate Portal</span></div>
