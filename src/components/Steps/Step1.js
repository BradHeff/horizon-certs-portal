          ...
          <div className="container text-center">
            <div className="section-title">
              ...
              <div className="section pt-0">
                  ...
                  <hr />
                  <a href={props.os === 0 ? cert : MAXcert} className="btn btn-outline-primary btn-cert px-5 my-3 my-xl-5 mr-xl-3"onClick={props.download} target="_blank" download={true} rel="noopener noreferrer">Download Certificate ({OS})</a>
                  <a href={props.os === 0 ? winApp : macApp} className="btn btn-outline-primary btn-cert px-5 my-xl-5">Download App ({OS})</a>
                  <a href="https://chrome.google.com/webstore/detail/connect-for-chrome-educat/ddfbkhpmcdbciejenfcolaaiebnjcbfc" target="_blank" rel="noopener noreferrer" className="btn btn-outline-primary btn-cert px-5 my-xl-0 my-sm-3">Download Extension For ChromeBook</a>
                  <hr />
